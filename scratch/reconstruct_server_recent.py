...
with open(log_path, 'r', encoding='utf-8') as f:
    for line in f:
        try:
            ...
            # Match only steps from today's session (step 4360 onwards)
            if step_index >= 4360 and type_name == 'VIEW_FILE' and 'File Path: `file:///home/oltonexeter/Antigravity-x64/quartz-international/server.ts`' in content:
