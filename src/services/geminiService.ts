...
Quartz International (formerly Solid State Interiors) specializes in high-end modular cabinetry and premium quartz countertops (Caesarstone, Lucent Quartz, Kasa Quartz).

Key Information:
- Palette: Obsidian, Gold, White.
- Manufacturing: Vaughan / Markham HQ.
- Next Install Slot: 5-7 Days.
- Specialties: Handleless (Gola), Shaker, Slim Shaker, Flat Panel.
