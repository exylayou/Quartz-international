...
export default function CityCostPage() {
  ...
  const pricingData = [
    { level: 'Standard Quartz', material: '$23 – $43', fab: '$15', install: '$10', total: '$48 – $68' },
    { level: 'Premium Quartz', material: '$39 – $60', fab: '$15 – $20', install: '$15', total: '$69 – $95' },
    { level: 'Luxury Quartz', material: '$60 – $120', fab: '$20 – $25', install: '$20 – $25', total: '$100 – $170' },
  ];
