  ...
  const faqs = [
    {
      ...
      a: "Most projects range from $48 to $170 per square foot installed, with total kitchen costs typically between $3,000 and $6,000."
    },
    {
      ...
      <section className="py-24 bg-background/50">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            >
              The cost of quartz countertops in Markham typically ranges from $48 to $170 per square foot installed, depending on your kitchen size, layout, and design preferences.
            </motion.p>
          </div>
