  ...
  const faqs = [
    {
      ...
      a: "Quartz countertops in Pickering typically range from $50 to $150 per square foot installed, with most kitchens falling between $3,000 and $6,000 depending on size and design."
    },
    {
      ...
      <section className="py-24 bg-background/50">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            >
              Quartz countertops in Pickering typically range from $50 to $150 per square foot installed, depending on material, layout, and design.
            </motion.p>
          </div>
