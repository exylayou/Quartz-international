...
export default function Caesarstone() {
  ...
  return (
    <div className="bg-background transition-colors duration-500">
      <SEO title="Caesarstone | Quartz International" description="Learn more about Caesarstone at Quartz International. We provide premium countertops and cabinetry in Toronto and the GTA." />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-500 mb-12 leading-relaxed font-medium">
              ...
              <br className="hidden md:block" /> Most Caesarstone kitchens: <span className="text-text-primary font-bold underline decoration-accent/20">$3,400 – $8,500 installed.</span>
            </p>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeIn} className="bg-white p-12 rounded-[3rem] border border-border-custom shadow-xl">
             ...
             <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
               <p>
                 Caesarstone quartz countertops in Toronto typically cost <span className="text-text-primary font-bold">$85–$170 per square foot installed</span>.
               </p>
               <p>
                 Most kitchens fall between <span className="text-text-primary font-bold">$3,400 and $8,500</span> depending on total square footage, design complexity, and specific installation details.
               </p>
             </div>
          </motion.div>
        </div>
