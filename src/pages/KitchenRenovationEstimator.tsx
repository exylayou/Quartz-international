...
export default function KitchenRenovationEstimator() {
  ...
  const calculateEstimate = () => {
    ...
    const cabinetLow = totalCabinetLF * cabRates.low;
    const cabinetHigh = totalCabinetLF * cabRates.high;
  ...
  const getWhatsAppUrl = () => {
    ...
    let msg = `Hi Quartz International, I just completed the online Kitchen Renovation Estimator. Here are my project details:\n\n`;
    msg += `\u2022 Cabinets: ${cabinetStyle.toUpperCase()} Collection (${deliveryMethod.toUpperCase()})\n`;
    msg += `\u2022 Cabinet Layout: ${Math.round(totalCabinetLF)} Linear FT\n`;
    ...
    msg += `\u2022 Countertops Est.: $${cost.countertopLow.toLocaleString()} - $${cost.countertopHigh.toLocaleString()}\n`;
    msg += `\u2022 Cabinets Est.: $${cost.cabinetLow.toLocaleString()} - $${cost.cabinetHigh.toLocaleString()}\n`;
    msg += `\u2022 Total Project Range: $${cost.totalLow.toLocaleString()} - $${cost.totalHigh.toLocaleString()}\n\n`;
  ...
  return (
    <div className="bg-[#FAF9F5] min-h-screen pt-6 pb-32">
      <SEO title="Kitchen Renovation Estimator | Quartz International" description="Learn more about Kitchen Renovation Estimator at Quartz International. We provide premium countertops and cabinetry in Toronto and the GTA." />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-start mt-8">
          {/* Left Form Column */}
          <div className={cn(step < 6 ? "lg:col-span-8" : "lg:col-span-12", "w-full")}>
                  ...
                  >
                    ...
                    {step === 1 && (
                      <div className="space-y-6">
                        <h2 className="text-2xl sm:text-3xl font-bold text-text-primary flex items-center gap-3">
                          ...
                          Choose Cabinet Delivery & Assembly Method
                        </h2>
                        <p className="text-gray-500 text-sm">Select how you want your cabinetry supplied.</p>

                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-4">
                          {[
                            { id: 'rta', name: 'RTA (Ready To Assemble)', desc: 'Flat-packed panels. Easy shipping, self assembly. Perfect for DIY projects.', icon: Layers, img: rtaDelivery },
                            { id: 'rti', name: 'RTI (Ready To Install)', desc: 'Factory assembled, ready to hang. Saves assembly labor on site.', icon: Truck, img: rtiDelivery },
                            { id: 'installed', name: 'Fully Installed', desc: 'Turnkey service. Includes professional measurements, alignment, and installation.', icon: Hammer, img: installedDelivery }
                          ].map((del) => (
                            <button
                              key={del.id}
                              type="button"
                    ...
                    {step === 2 && (
                      <div className="space-y-6">
                        ...
                        <p className="text-gray-500 text-sm">Select the quality and door finish collection.</p>

                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-4">
                          {[
                            { id: 'essential', title: 'Essential Collection', desc: 'Durable and beautiful flat-panel finishes.', img: essentialKitchenBanner },
                            { id: 'premium', title: 'Premium Collection', desc: 'Matte, gloss and traditional shaker designs.', img: premiumKitchenBanner, badge: 'Popular' },
                            { id: 'elite', title: 'Elite Collection', desc: 'Elevated slim shaker painted hardwood doors.', img: eliteKitchenBanner }
                          ].map((cab) => (
                            <button
                              key={cab.id}
                              type="button"
                    ...
                    {step === 4 && (
                      <div className="space-y-6">
                        ...
                        <p className="text-gray-500 text-sm">Configure your kitchen central island style.</p>

                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 py-4">
                          {[
                            { id: 'none', title: 'No Island', desc: 'No kitchen island is required.', img: condoKitchen },
                            { id: 'small', title: 'Small Island', desc: 'Cozy seating peninsula (+12 sq ft countertop / +4 LF cabinet).', img: suburbanRemodel },
                            { id: 'large', title: 'Large Island', desc: 'Spacious central hub (+20 sq ft countertop / +8 LF cabinet).', img: familyKitchen },
                            { id: 'waterfall', title: 'Island + Waterfall', desc: 'Waterfalls on side panels (+35 sq ft countertop / +8 LF cabinet).', img: modernKitchenQuartz }
                          ].map((opt) => (
                            <button
                              key={opt.id}
                              type="button"
                    ...
                    {/* STEP 5: Quartz Collection */}
                    {step === 5 && (
                      <div className="space-y-6">
                        <h2 className="text-2xl sm:text-3xl font-bold text-text-primary flex items-center gap-3">
                          <Sparkles className="text-accent" />
                          Choose Quartz Collection
                        </h2>
                        <p className="text-gray-500 text-sm">Select the engineered quartz stone collection.</p>
                    ...
                    {/* STEP 6: Results Reveal & Lead Form */}
                    {step === 6 && (
                      <div className="space-y-6">
                        {!showForm ? (
                            ...
                            <div className="inline-block bg-[#1A1A1A] text-white p-5 xs:p-6 sm:p-12 rounded-[2rem] sm:rounded-[3.5rem] text-center relative overflow-hidden group w-full max-w-xl mx-auto shadow-2xl">
                              ...
                              <div className="max-w-md mx-auto bg-[#F8F9FA] rounded-3xl border border-[#E5E2DC] p-5 sm:p-8 mt-8 space-y-4 text-center sm:text-left text-[#1A1A1A]">
                                <div className="flex flex-col sm:flex-row justify-between items-center text-sm font-bold border-b border-[#E5E2DC] pb-4 gap-2 sm:gap-0">
                                  <span className="text-gray-400 uppercase tracking-widest text-[10px]">Renovation Package • L-Shape</span>
                                  <span className="text-accent uppercase tracking-widest text-[10px] italic">Combined Project</span>
                                </div>
                                <div className="flex justify-between items-center text-sm font-bold border-b border-[#E5E2DC] pb-4">
                                  <span className="text-gray-400 uppercase tracking-widest text-[10px]">Cabinets ({Math.round(totalCabinetLF)} LF • {cabinetStyle} • {deliveryMethod.toUpperCase()})</span>
                          ...
                          <div className="space-y-6 animate-fadeIn">
                            ...
                            <h2 className="text-2xl sm:text-3xl font-bold text-text-primary flex items-center gap-3">
                              ...
                              Receive Your Full Renovation Cost Summary
                            </h2>
                            <p className="text-gray-500 text-sm">Please fill out the form below. We will immediately email your combined countertop & cabinetry budgetary estimate.</p>
                            ...
                            <form onSubmit={handleFormSubmit} className="space-y-4 max-w-lg py-4">
                              ...
                              <div>
                                ...
                                <textarea 
                                  placeholder="e.g. Renovation details, removal requirements..."
                  ...
                  >
                    ...
                    <div className="text-center space-y-3">
                      ...
                      <p className="text-gray-500 text-sm max-w-md mx-auto leading-relaxed">
                        Thank you, <span className="text-text-primary font-bold">{formData.name}</span>. We have successfully sent a combined cabinetry & countertop budgetary estimate report to <span className="text-text-primary font-bold">{formData.email}</span>. A representative will contact you to schedule your site measure.
                      </p>
                    </div>
                    ...
                    <div className="max-w-md mx-auto border border-border-custom rounded-2xl p-6 bg-white space-y-4">
                      ...
                      <div className="space-y-3 text-xs">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="font-bold text-accent uppercase tracking-widest text-[10px]">{quartzLevel}</span>
                        </div>
                        <div className="flex justify-between">
              ...
              <div className="bg-white rounded-3xl border border-border-custom p-6 md:p-8 shadow-sm space-y-6">
                ...
                <div className="bg-[#FAF9F5] p-5 rounded-2xl border border-border-custom space-y-1.5">
                  ...
                  <p className="text-[11px] text-gray-600 leading-relaxed font-semibold italic">
                    {step === 1 && "RTA cabinets arrive flat-packed, while RTI cabinets come pre-assembled. Fully installed includes turnkey design, alignment, and secure placement."}
                    {step === 2 && "European frameless cabinets maximize internal cabinet volume. Select standard essential, premium timeless shaker, or designer elite painted hardwood collection."}
                    {step === 3 && "For cabinet layout length, count all wall runs where base or wall cabinetry will be installed."}
                    {step === 4 && "An island is the perfect central focal point. Opt for small, large, or a mitered waterfall stone end profile to elevate the aesthetics."}
                    {step === 5 && "Standard collections offer great durability. Premium levels introduce Calacatta veining, and Luxury levels feature high-end custom styles."}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="w-[210mm] h-[297mm] bg-white p-20 flex flex-col justify-between text-[#1A1A1A] font-sans">
            ...
            <div className="max-w-2xl">
               ...
               <div className="inline-flex items-center gap-3 bg-accent/10 px-6 py-3 rounded-2xl mb-8 border border-accent/20">
                  ...
                  <p className="text-sm font-black text-[#1A1A1A] uppercase tracking-widest italic">Specified Selection: Premium Renovation Package</p>
               </div>
