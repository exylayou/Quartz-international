...
export default function Cost() {
  ...
  const faqs = [
    { q: 'How much do quartz countertops cost in GTA?', a: 'Most kitchens cost between $2,000 and $5,000 installed depending on size and quartz level.' },
        ...
        <div className="bg-[#FFF9F3] border border-[#FDECD9] p-8 rounded-3xl flex items-start gap-6">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed text-sm">
              The average quartz countertop cost in Toronto & GTA is <span className="font-bold text-text-primary">$48–$170 per square foot</span> installed, 
              with most kitchens costing between <span className="font-bold text-text-primary">$2,000 and $8,500</span> depending on size, material, and design.
            </p>
          </div>
        </div>
      </section>
