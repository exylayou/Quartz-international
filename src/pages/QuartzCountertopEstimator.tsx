              ...
              <AnimatePresence mode="wait">
                {!isSubmitted ? (
                        ...
                        <div className="bg-[#FAF9F6] border border-[#E5E2DC] rounded-3xl p-4 sm:p-6 flex items-center gap-4 sm:gap-6">
                          ...
                          <div>
                            <h4 className="font-bold text-[#1A1A1A] text-xs sm:text-base">
                              Calculated Countertop Area: {countertopSqFt} SQ FT
                            </h4>
                            <p className="text-gray-400 font-semibold text-[10px] sm:text-xs italic mt-1 leading-relaxed">
                              Formula: (Wall length × 2) - 5 appliance allowance + island/peninsula add-on
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    ...
                    <div className="bg-white p-6 sm:p-10 rounded-3xl border-4 border-dashed border-[#E5E2DC] max-w-sm mx-auto space-y-6">
