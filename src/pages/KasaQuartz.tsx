...
const faqs = [
  { q: 'What makes Kasa Quartz different from other brands?', a: 'Kasa Quartz offers premium quality engineered quartz slabs tailored for modern living, providing high-end design aesthetics local to the Toronto market at competitive pricing.' },
  { q: 'How does Kasa Quartz compare to granite?', a: 'Kasa Quartz is non-porous, meaning it never needs to be sealed. It is more resistant to stains, scratches, and impact than natural granite, making it ideal for high-traffic Toronto kitchens.' },
  { q: 'Is Kasa Quartz more expensive than Caesarstone?', a: 'Kasa Quartz offers exceptional value for premium designs, making it a highly competitive choice in similar quality tiers with excellent warranties.' },
    ...
    <div className="bg-background transition-colors duration-500">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <button onClick={() => openCalculator({ brand: 'Kasa Quartz' })} className="btn-primary px-12 py-6 h-auto text-lg font-bold shadow-2xl shadow-accent/20 group">
      ...
      <section className="py-24 bg-[#F8F9FA] border-y border-border-custom">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeIn} className="bg-white p-12 rounded-[3rem] border border-border-custom shadow-xl text-center md:text-left">
             <h2 className="text-3xl font-bold text-text-primary mb-6 tracking-tight">Toronto Kasa Quartz Pricing Guide</h2>
      ...
      <section className="py-32 bg-[#F8F9FA]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500">See Kasa Quartz in actual high-end kitchen installations.</p>
          </div>
            ...
            <div className="order-2 lg:order-1">
              <div className="rounded-[3rem] overflow-hidden shadow-2xl relative">
                ...
                <div className="absolute bottom-10 left-10 bg-white/90 backdrop-blur-sm p-6 rounded-2xl shadow-xl max-w-xs">
                  ...
                  <p className="text-sm font-medium text-text-primary italic">"Kasa Quartz is my top recommendation for clients who want local premium style and durability."</p>
                </div>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              <h2 className="text-4xl font-bold text-text-primary mb-8 tracking-tight">The Kasa Quartz Advantage</h2>
              <div className="space-y-6">
                {[
                  { title: 'Eco-Friendly Options', desc: 'Sustainable manufacturing processes using recycled materials and energy-efficient operations.' },
                  { title: 'Extreme Durability', desc: 'High resistance to impacts, scratches, and common household stains.' },
                  { title: 'Stunning Color Depth', desc: 'Over 80 styles available, with unmatched clarity and veining definition.' },
                  { title: 'Outstanding Warranty', desc: 'Peace of mind with a transferable limited warranty on all Kasa Quartz surfaces.' }
                ].map((item, i) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            <div className="lg:w-1/2">
              <h2 className="text-4xl font-bold text-text-primary mb-8 tracking-tight">Calculate Your Kasa Quartz Project</h2>
            ...
            <div className="lg:w-1/2 bg-white rounded-[3rem] p-12 border border-border-custom shadow-xl relative overflow-hidden group">
               ...
               <p className="text-gray-500 mb-10 leading-relaxed">No guesswork. No hidden fees. Just transparent Kasa Quartz pricing based on your kitchen\'s specific dimensions.</p>
               <button onClick={() => openCalculator({ brand: 'Kasa Quartz' })} className="w-full p-8 border-2 border-accent/20 rounded-3xl flex items-center justify-between hover:border-accent hover:bg-accent/5 transition-all">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-text-primary tracking-tight underline decoration-accent/20 underline-offset-8">Kasa Quartz FAQ</h2>
          </div>
      ...
      <section className="py-32 bg-accent relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-8 tracking-tighter">Ready for Your Kasa Quartz Upgrade?</h2>
          <p className="text-xl text-white/80 mb-12 leading-relaxed">
            Get your instant Kasa Quartz quote and schedule your final measurement. Toronto\'s trusted surface experts are ready to help.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <button onClick={() => openCalculator({ brand: 'Kasa Quartz' })} className="bg-white text-accent px-12 py-6 rounded-full font-bold text-lg hover:bg-text-primary hover:text-white transition-all shadow-2xl">
              Calculate My Price
            </button>
