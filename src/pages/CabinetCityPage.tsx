...
import { cabinetCities as cities } from '../data/cabinetCities';

// cache bust 3

export default function CabinetCityPage() {
  ...
  const faqs = [
    {
      q: `How much do kitchen cabinets cost in ${cityData.name}?`,
      a: `Kitchen cabinets in ${cityData.name} typically range from $2,100 for RTA options up to $9,000+ for large fully installed custom setups.`
    },
    {
      q: "How long does installation take?",
      a: "RTA and RTI cabinets are available quickly. Full installations are typically completed within 1-2 weeks depending on the kitchen size."
    },
    {
      q: "What affects the cost of kitchen cabinets?",
      a: "Pricing depends on: Kitchen size, layout (number of cabinets), finish style (matte, gloss, wood), and delivery method (RTA, RTI, or Installed)."
    },
    {
    ...
    },
    {
      ...
      a: "Not at all! We offer Ready-To-Assemble (RTA) for DIYers, but we also offer Ready-To-Install (RTI) factory-built cabinets, and Full Professional Installation."
    },
    {
    ...
    },
    {
      ...
      a: `Yes. We install kitchen cabinets across ${cityData.areasServed}.`
    }
  ];
  ...
  return (
    <div className="bg-white min-h-screen font-sans selection:bg-accent/30">
      <SEO 
        title={`Kitchen Cabinets ${cityData.name} | Quartz International`} 
        description={`Premium kitchen cabinets and kitchen cabinetry installed in ${cityData.name}. Get an instant, accurate online estimate for your new kitchen today.`} 
      />
            ...
            <div className="text-center lg:text-left order-1 lg:order-1">
              ...
              >
                <span className="text-gray-500 font-bold uppercase tracking-[0.4em] text-[10px] sm:text-xs">
                  {cityData.name} & {cityData.region} Kitchen Cabinet Specialists
                </span>
              </motion.div>
              ...
              >
                Kitchen Cabinets in {cityData.name} — <span className="text-accent">Get Your Exact Price in 30 Seconds</span>
              </motion.h1>
              ...
              >
                Instant, accurate pricing for kitchen cabinets across {cityData.name} and the {cityData.region}. No obligation. No hidden costs.
              </motion.p>
            ...
            >
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-[0_32px_64px_-12px_rgba(0,0,0,0.15)] group">
                <img 
                  ...
                  alt={`Kitchen cabinets ${cityData.name} installation`} 
      ...
      <section className="py-24 bg-background/50">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="border-t border-gray-200 pt-20">
            <h3 className="text-3xl font-bold mb-12 text-center">What Impacts Kitchen Cabinet Cost?</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-16">
              <div className="space-y-8">
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    ...
                    { title: "Cabinet Finishes", desc: "High gloss, matte, shaker, or slim shaker styles.", icon: <Check size={20} /> },
                    { title: "Delivery Method", desc: "RTA, RTI, or Fully Installed turnkey service.", icon: <Layers size={20} /> },
                    { title: "Custom Modifications", desc: "Pantry pullouts, matching islands, lazy susans.", icon: <Maximize size={20} /> },
                  ].map((item, i) => (
                    <motion.li 
                      key={item.title}
                      initial={{ opacity: 0, y: 10 }}
                ...
                <div className="p-6 bg-gray-50 rounded-xl border border-gray-100">
                  <p className="text-sm text-gray-500 flex items-center gap-2">
                    ...
                    We install kitchen cabinets across {cityData.areasServed}.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-lg border border-white bg-gray-100">
                    <img 
                      src="/assets/modern_two_tone.png" 
                      alt="Modern two tone kitchen cabinets" 
                      className="w-full h-full object-cover"
                      referrerPolicy="no-referrer"
                    />
                  </div>
                  <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400 text-center">Modern Finishes</p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <motion.h2 
              ...
              className="text-4xl md:text-5xl font-bold mb-6"
            >
              Real Kitchen Cabinet Transformations in {cityData.name}
            </motion.h2>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              See how {cityData.name} homeowners upgraded their kitchens with modern kitchen cabinets.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "5,000+ kitchens installed across the GTA.",
                    icon: <Award size={24} />
                  }
                ].map((pillar, i) => (
                  <motion.div
            ...
            >
              <div className="aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-2xl group bg-gray-50">
                <img 
                  ...
                  alt="Cabinet assembly and installation process" 
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                  referrerPolicy="no-referrer"
                />
        ...
        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center mb-16">
            <motion.h2 
              ...
              className="text-4xl md:text-5xl font-bold mb-6 text-text-primary"
            >
              Kitchen Cabinets {cityData.name} — Frequently Asked Questions
            </motion.h2>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="text-lg text-gray-600"
            >
              Get clear answers about pricing, installation, and choosing the right kitchen cabinets for your {cityData.name} home.
            </motion.p>
          </div>
      ...
      <section className="py-32 bg-text-primary relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img 
            ...
            alt="Luxury kitchen cabinet detail" 
            className="w-full h-full object-cover"
            referrerPolicy="no-referrer"
          />
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              Get Your Exact Kitchen Cabinet Price in 30 Seconds
            </motion.h2>
