...
export default function Scarborough() {
  ...
  const faqs = [
    {
      q: "How much do quartz countertops cost in Scarborough?",
      a: "Quartz countertops in Scarborough typically range from $48 to $170 per square foot installed, with most kitchens falling between $3,000 and $6,000 depending on size and design."
    },
    {
    ...
    {
      q: "Do you serve areas outside Scarborough?",
      a: "Yes. We serve North York, The Beaches, Markham, and the entire GTA with professional quartz installation."
    }
  ];
            ...
            <div className="text-center lg:text-left order-1 lg:order-1">
              ...
              >
                <span className="text-gray-500 font-bold uppercase tracking-[0.4em] text-[10px] sm:text-xs">
                  Scarborough & East End Quartz Specialists
                </span>
              </motion.div>
              ...
              >
                Quartz Countertops in Scarborough — <span className="text-accent">Get Your Exact Price in 30 Seconds</span>
              </motion.h1>
              ...
              >
                Instant, accurate pricing for quartz countertops in Scarborough and the GTA. No obligation. No hidden costs.
              </motion.p>
              ...
              >
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="font-semibold text-text-primary">Serving Scarborough, North York & Beaches</span>
                </div>
              </motion.div>
            </div>
            ...
            >
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-[0_32px_64px_-12px_rgba(0,0,0,0.15)] group">
                <img 
                  ...
                  alt="Quartz countertops Scarborough installation" 
      ...
      <section className="py-24 bg-background/50">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            >
              Quartz Countertop Cost in Scarborough <br className="hidden md:block" />
            ...
            >
              Quartz countertops in Scarborough typically range from $48 to $170 per square foot installed, depending on material, layout, and design.
            </motion.p>
          </div>
            ...
            {[
              {
                ...
                price: "$48 – $68",
                features: ["Clean, simple, everyday styles", "Great for budget renovations"],
              ...
              },
              {
                ...
                popular: true,
                price: "$69 – $95",
                features: ["More pattern, movement, and design options", "Best value for most homeowners"],
          ...
          <div className="text-center mb-20">
            <p className="inline-block bg-text-primary text-white px-6 py-2 rounded-full text-sm font-bold">
              Most kitchens in Scarborough range from $3,000 – $6,000 installed.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <motion.h2 
              ...
              className="text-4xl md:text-5xl font-bold mb-6"
            >
              Recent Quartz Installations in Scarborough
            </motion.h2>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="text-lg text-gray-600"
            >
              See how homeowners in Scarborough are upgrading their kitchens with modern quartz countertops.
            </motion.p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            <div>
              ...
              >
                Why Scarborough Homeowners Choose Quartz International for Their Countertops
              </motion.h2>
              <motion.p 
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                Precision fabrication, transparent pricing, and fast installation — trusted across Scarborough and the GTA.
              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="flex flex-col items-center gap-1">
              ...
              <span className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">Scarborough & GTA</span>
            </div>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center mb-16">
            <motion.h2 
              ...
              className="text-4xl md:text-5xl font-bold mb-6 text-text-primary"
            >
              Quartz Countertops Scarborough — Frequently Asked Questions
            </motion.h2>
          </div>
