...
import miamiVena from '../assets/images/silestone-miami-vena.jpg';
import pietra from '../assets/images/silestone-pietra.jpg';
import yukon from '../assets/images/silestone-yukon.jpg';
import miamiWhite from '../assets/images/silestone-miami-white.jpg';
import halcyon from '../assets/images/silestone-halcyon.jpg';
...
const slabs = [
  { name: 'Miami Vena', price: '$85–$105', img: miamiVena },
  { name: 'Silestone Pietra', price: '$90–$110', img: pietra },
  { name: 'Silestone Yukon', price: '$80–$100', img: yukon },
  { name: 'Miami White', price: '$80–$100', img: miamiWhite },
  { name: 'Halcyon', price: '$95–$115', img: halcyon },
];
...
const faqs = [
  { q: 'Is Silestone expensive?', a: 'Silestone is considered a premium quartz brand. While more expensive than entry-level stones, it offers superior durability, innovative features like HybriQ+, and a world-class design palette that maintains high resale value.' },
  ...
  { q: 'Does it stain or scratch?', a: 'Silestone is highly resistant to both stains and scratches. However, we always recommend using cutting boards and trivets to maintain the surface for decades.' },
];
  ...
  return (
    <div className="bg-background transition-colors duration-500">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-500 mb-12 leading-relaxed font-medium">
              Explore Silestone quartz styles and see real kitchen pricing in the GTA. 
              <br className="hidden md:block" /> Most Silestone kitchens: <span className="text-text-primary font-bold underline decoration-accent/20">$5,000 – $9,000 installed.</span>
            </p>
      ...
      <section className="py-24 bg-[#F8F9FA] border-y border-border-custom">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeIn} className="bg-white p-12 rounded-[3rem] border border-border-custom shadow-xl">
             <h2 className="text-3xl font-bold text-text-primary mb-6 tracking-tight">How Much Does Silestone Quartz Cost?</h2>
             <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
               <p>
                 Silestone quartz countertops in Toronto typically cost <span className="text-text-primary font-bold">$70–$110 per square foot installed</span>.
               </p>
               <p>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-text-primary mb-4 tracking-tight leading-none">Popular Silestone Designs</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {slabs.map((slab, idx) => (
              ...
              >
                <Link to={`/slab/${slab.name.toLowerCase().replace(/\s+/g, '-')}`} className="aspect-video overflow-hidden block">
      ...
      <section className="py-32 bg-[#F8F9FA]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-text-primary mb-4 tracking-tight leading-none">Silestone Kitchens in Toronto</h2>
      ...
      {/* 5. WHY CHOOSE SILESTONE */}
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-4xl font-bold text-text-primary mb-8 tracking-tight">Why Homeowners Choose Silestone</h2>
              <div className="space-y-6">
                {[
                  { title: 'HybriQ+ Technology', desc: 'Sustainable manufacturing with renewable energy and recycled water.' },
                  ...
                  { title: 'Trusted Global Brand', desc: 'A leading quartz surface brand with a solid 25-year warranty.' }
                ].map((item, i) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-20">
            ...
            <div className="lg:w-1/2 bg-white rounded-[3rem] p-12 border border-border-custom shadow-xl flex flex-col justify-center">
               ...
               <p className="text-gray-500 mb-10 leading-relaxed">Our calculator is mapped to 2026 GTA pricing for Silestone collections.</p>
               <button onClick={() => openCalculator({ brand: 'Silestone' })} className="group p-8 border-2 border-accent/20 rounded-3xl flex items-center justify-between hover:border-accent hover:bg-accent/5 transition-all">
                  <div className="flex items-center gap-6">
                    ...
                    <div className="text-left">
                       ...
                       <p className="text-xs text-gray-400 font-bold uppercase tracking-widest">Silestone Pricing Tier</p>
                    </div>
                  </div>
      ...
      <section className="py-32 bg-accent relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-white/80 mb-12 leading-relaxed">
            Get your instant Silestone quote today. No showrooms required, just transparent Toronto pricing.
          </p>
          <button onClick={() => openCalculator({ brand: 'Silestone' })} className="bg-white text-accent px-12 py-6 rounded-full font-bold text-lg hover:bg-text-primary hover:text-white transition-all shadow-2xl inline-block">
