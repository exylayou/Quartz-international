...
import look4 from '../assets/images/regenerated_image_1777699854744.jpg';
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex overflow-x-auto pb-8 gap-4 no-scrollbar -mx-4 px-4 sm:mx-0 sm:px-0">
            {[
              { img: inspired1, type: 'Modern Condo', price: '$4,200 – $5,800' },
              { img: inspired2, type: 'Family Kitchen', price: '$6,500 – $8,200' },
              { img: inspired3, type: 'Custom Luxury', price: '$10,000 – $14,000' },
              { img: inspired4, type: 'Urban Penthouse', price: '$5,500 – $7,500' },
              { img: 'https://images.unsplash.com/photo-1556912173-3bb406ef7e77', type: 'Suburban Remodel', price: '$7,800 – $9,500' }
            ].map((item, i) => (
              <div key={i} className="w-[180px] md:w-[260px] aspect-square rounded-2xl overflow-hidden shadow-sm relative group shrink-0">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent p-5 flex flex-col justify-end">
                   ...
                   <button onClick={() => openCalculator()} className="bg-white text-text-primary px-3 py-1.5 rounded-full font-black text-[8px] w-fit hover:bg-accent hover:text-white transition-all uppercase tracking-widest leading-none">
                     Get Price
                   </button>
                </div>
              </div>
